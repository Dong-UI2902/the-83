  ...
  return (
    <div>
      ...
      >
          ...
          <Grid container spacing={4}>
            <Grid item md={6}>
              ...
              <p>
                ...
                hàng chất lượng, giá rẻ thì The83 là sự lựa chọn tuyệt vời dành
                cho bạn.
              </p>
            </Grid>
            <Grid item md={6}>
        ...
        <Box className="section">
          <center>
            <h1>Lợi ích khi sử dụng dịch vụ của The83</h1>
            <p>
              Với hơn 6 năm kinh nghiệm trong việc tìm kiếm nguồn hàng cho hàng
              trăm khách hàng, The83 thấu hiểu được nhu cầu về dịch vụ của khách
              hàng, The83 tự tin là bến đỗ cho các bạn, đặc biệt là các bạn mới
              bước chân vào kinh doanh, giúp bạn giải đáp các thắc mắc, băn
              khoăn về dự định nhập hàng và giúp bạn kết nối được với những nhà
              cung cấp uy tín.
            </p>
          </center>
        ...
        <Box className="section">
          <Grid container alignItems="end" spacing={4} justifyContent="center">
            ...
            <Grid item md={5}>
              ...
              <p>
                <strong>Bước 1:</strong> Khách hàng liên hệ The83 để tìm nguồn
                hàng.
              </p>
              <p>
                <strong>Bước 2:</strong> The83 gửi báo giá tìm nguồn hàng đến
                khách hàng. Nếu khách hàng đồng ý, 2 bên tiến hành ký hợp đồng.
              </p>
              <p>
                <strong>Bước 3:</strong> Khách hàng gửi thông tin cụ thể (mẫu
                mã, số lượng) để The83 tìm nguồn phù hợp.
              </p>
              <p>
                <strong>Bước 4:</strong> The83 tìm nguồn và đưa ra list các nhà
                cung cấp để khách hàng lựa chọn.
              </p>
              <p>
                <strong>Bước 5:</strong> The83 làm việc với nhà cung cấp để đưa
                hàng về.
              </p>
              <p>
...
const ListItem = [
  ...
  },
  {
    ...
    icon: <SpeakerNotesOffIcon sx={{ fontSize: "5rem" }} />,
  },
  {
    ...
    icon: <ConnectWithoutContactIcon sx={{ fontSize: "5rem" }} />,
  },
  {
    ...
    icon: <RemoveCircleOutlineIcon sx={{ fontSize: "5rem" }} />,
  },
];
...
const ListItem2 = [
  {
    ...
    desc: "Với kinh nghiệm làm việc với hàng trăm nhà cung cấp, đặc biệt là các xưởng sản xuất tại Trung Quốc, The83 chắc chắn giúp bạn tìm được nguồn hàng ưng ý. Với kỹ năng giao dịch, đàm phán chuyên nghiệp cùng với vốn kiến thức về ngành hàng, The83 tự tin rằng, có thể giúp bạn xây dựng mối quan hệ kinh doanh lâu dài với nhà cung cấp, đảm bảo cả 2 bên cùng có lợi.",
    icon: <ForumIcon sx={{ fontSize: "5rem" }} />,
  },
  {
    name: "Hàng tốt – Giá cực tốt",
    desc: "Trong hơn 8 năm vận hành, The83 đã có kinh nghiệm làm việc với rất nhiều nhà cung cấp của nhiều ngành hàng khác nhau, cũng như xúc tiến được rất nhiều lô hàng, quan hệ với nhiều đối tác nước ngoài, đặc biệt là Trung Quốc rất ổn định, nên có thể đảm bảo với các bạn rằng, có thể mang đến cho khách hàng những lợi thế về nguồn hàng cực tốt, hàng chất lượng với mức giá tối ưu. ",
    icon: <ThumbUpOffAltIcon sx={{ fontSize: "5rem" }} />,
  },
  {
    name: "Chọn lựa nhà cung cấp uy tín",
    desc: "Ngoài những tiêu chí cơ bản để đánh giá nhà cung cấp, The83 có những tiêu chí riêng để lựa chọn nhà cung cấp, đảm bảo với khách hàng về chất lượng của nguồn hàng. Ngoài ra, với mỗi lô hàng được xúc tiến, sau khi nhận được hàng, The83 luôn luôn lắng nghe, tiếp nhận phản hồi của khách hàng để đánh giá lại lần nữa nhà cung cấp. Với kinh nghiệm tiến hành nhập khẩu nhiều lô hàng, khách hàng hoàn toàn có thể tin tưởng vào The83.",
    icon: <InventoryIcon sx={{ fontSize: "5rem" }} />,
  },
  {
    name: "Thanh toán đơn giản",
    desc: "The83 cung cấp nhiều giải pháp thanh toán khác nhau cho khách hàng, dựa vào tình hình thực tế để đưa ra phương thức thanh toán hợp lý nhất, với mức phí tối ưu nhất. Không chỉ vậy, The83 còn đảm bảo với khách hàng về thời gian chuyển tiền, cam kết chuyển tiền nhanh chóng, uy tín.",
    icon: <CreditScoreIcon sx={{ fontSize: "5rem" }} />,
  },
  {
    name: "Giấy tờ pháp lý đầy đủ – hợp đồng rõ ràng",
    desc: "Với mỗi khách hàng khi sử dụng dịch vụ tìm nguồn hàng của The83, công ty đều tiến hành ký kết hợp đồng với khách hàng, quy định rõ nghĩa vụ và trách nhiệm của các bên. Các bạn hoàn toàn có thể tin tưởng rằng, nếu có bất cứ vấn đề nào xảy ra trong quá trình sử dụng dịch vụ của The83, chúng tôi luôn luôn đứng ra giải quyết, đảm bảo quyền lợi của khách hàng.",
    icon: <ChecklistIcon sx={{ fontSize: "5rem" }} />,
  },
  {
    name: " Được chăm sóc từ A – Z cho tới khi hàng về kho của bạn",
    desc: "Bên cạnh dịch vụ chính là  tìm nguồn hàng, The83 còn cung cấp nhiều giải pháp Logistics khác để đưa hàng về kho của bạn. Chúng tôi không chỉ dừng lại ở việc tìm ra nhà cung cấp hợp lý cho bạn, mà còn cùng bạn trên hành trình nhập hàng về kho, giải đáp và đưa ra những giải pháp phù hợp nếu có bất cứ phát sinh nào trong quá trình nhập hàng.",
